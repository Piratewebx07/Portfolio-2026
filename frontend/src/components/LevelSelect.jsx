...
const LevelCard = ({ project, onClick }) => {
  // Jumpp needs portrait aspect ratio
  ...
  return (
    ...
    >
      {/* Image - portrait for Jumpp, landscape for others */}
      <div className={`${isJumpp ? 'aspect-[3/4]' : 'aspect-video'} overflow-hidden bg-black`}>
        <img
          src={project.images[0]}
          alt={project.title}
          className={`w-full h-full ${isJumpp ? 'object-contain' : 'object-cover'} transition-transform duration-500 group-hover:scale-110`}
        />
